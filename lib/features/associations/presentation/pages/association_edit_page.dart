...
class AssociationEditPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const AssociationEditView(),
    );
  }
}
...
class _AssociationEditViewState extends State<AssociationEditView> {
  ...
  void _showSaveConfirmation(BuildContext context, bool isCreating) {
    final l10n = AppLocalizations.of(context);
    showDialog(
      context: context,
      builder: (dialogContext) => AlertDialog(
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(l10n.association),
          actions: [
            BlocBuilder<AssociationEditBloc, AssociationEditState>(
                ...
                if (state is AssociationEditLoaded) {
                  return IconButton(
                    ...
                    onPressed: state.isSaving
                        ? null
                        : () =>
                            _showSaveConfirmation(context, state.isCreating),
                  );
                }
        ...
        body: BlocListener<AssociationEditBloc, AssociationEditState>(
