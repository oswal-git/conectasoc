...
abstract class AppLocalizations {
  ...
  /// No description provided for @readScope.
  ///
  /// In es, this message translates to:
  /// **'Ámbito de lectura'**
  String get readScope;

  /// No description provided for @readScopeAdmin.
  ///
  /// In es, this message translates to:
  /// **'Admin y superiores'**
  String get readScopeAdmin;

  /// No description provided for @readScopeAdminHelp.
  ///
  /// In es, this message translates to:
  /// **'Visible para superadmin y admin de la asociación'**
  String get readScopeAdminHelp;

  /// No description provided for @readScopeAsociado.
  ///
  /// In es, this message translates to:
  /// **'Todos de la asociación'**
  String get readScopeAsociado;

  /// No description provided for @readScopeAsociadoHelp.
  ///
  /// In es, this message translates to:
  /// **'Visible para todos los miembros de la asociación'**
  String get readScopeAsociadoHelp;

  /// No description provided for @readScopeEditor.
  ///
  /// In es, this message translates to:
  /// **'Editor y superiores'**
  String get readScopeEditor;

  /// No description provided for @readScopeEditorHelp.
  ///
  /// In es, this message translates to:
  /// **'Visible para superadmin, admin y editores de la asociación'**
  String get readScopeEditorHelp;

  /// No description provided for @readScopeSuperadmin.
  ///
  /// In es, this message translates to:
  /// **'Solo Superadmin'**
  String get readScopeSuperadmin;

  /// No description provided for @readScopeSuperadminHelp.
  ///
  /// In es, this message translates to:
  /// **'Solo visible para superadmin'**
  String get readScopeSuperadminHelp;
  ...
  /// No description provided for @uploadDateFormat.
  ///
  /// In es, this message translates to:
  /// **'dd \'de\' MMMM \'de\' y, \'a las\' HH:mm:ss'**
  String get uploadDateFormat;
